...
var _default = {
  ...
  methods: {
    ...
    checkSignup: function checkSignup() {
      alert("회원가입 성공");
      this.flag = 0;
...
exports.default = _default;
        var $2fdd41 = exports.default || module.exports;
      
      if (typeof $2fdd41 === 'function') {
        $2fdd41 = $2fdd41.options;
      }
    
        /* template */
        Object.assign($2fdd41, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "sheet" }, [
    ...
    _c("div", { staticClass: "middle" }, [
      _c(
        "div",
        { staticClass: "right-window" },
        [
          _c("div", [_vm._v("메뉴 리스트")]),
          _vm._v(" "),
          _vm._l(_vm.items, function(item, index) {
            return _c(
              ...
              [
                _c("div", [_vm._v(_vm._s(item[(index, 0)]))]),
                _vm._v(" "),
                _c("button", [_vm._v(_vm._s(item[(index, 0)]))]),
                _vm._v(" "),
                _c("div", [_vm._v(_vm._s(item[(index, 1)]) + "원")])
              ]
            )
          })
        ],
      ...
      _vm._v(" "),
      _c("div", { staticClass: "left-window" }, [
        _c("div", { staticClass: "platform" }, [
          _vm._v("로그인\n                    "),
          _c("div", { staticClass: "id-box" }, [
            _c("div", { staticClass: "id-box1", attrs: { length: "10" } }, [
              _vm._v("id:")
            ]),
            _vm._v(" "),
            _c("input", {
          ...
          _c("div", { staticClass: "check-box" }, [
            _c(
              "button",
              { staticClass: "login", on: { click: _vm.checkLogin } },
              [_vm._v("login")]
            ),
            _vm._v(" "),
            _c(
              "button",
              { staticClass: "sign-up ", on: { click: _vm.checkSignup } },
              [_vm._v("sign-up")]
            )
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "begged-item" }, [_vm._v("담은 메뉴 ")]),
        _vm._v(" "),
        _c("div", { staticClass: "view-item" }, [_vm._v(_vm._s(_vm.fooditem))]),
        _vm._v(" "),
        _c("div", { staticClass: "view-total" }, [
          _c("div", { staticClass: "view-real" }, [
            _vm._v("금액 : " + _vm._s(_vm.don))
          ]),
          _vm._v(" "),
          _c(
            "button",
            { staticClass: "paybutton", on: { click: _vm.checkPay } },
            [_vm._v("결제하기")]
          )
        ])
      ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "top" }, [
      _c("div", { staticClass: "top-title" }, [_vm._v('"MOM"BOX')]),
      _vm._v(" "),
      _c("div", { staticClass: "top-main" }, [
        _c("div", { staticClass: "top-menu" }, [_vm._v("메뉴")]),
        _vm._v(" "),
        _c("div", { staticClass: "top-info" }, [_vm._v("구독 정보")]),
        _vm._v(" "),
        _c("div", { staticClass: "top-infoco" }, [_vm._v("회사 정보")])
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2fdd41', $2fdd41);
          } else {
            api.reload('$2fdd41', $2fdd41);
          }
        }
